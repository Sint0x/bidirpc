...
class BidirectionalStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetServerResponse = channel.stream_stream(
                ...
                request_serializer=bidi__pb2.Message.SerializeToString,
                response_deserializer=bidi__pb2.Message.FromString,
...
def add_BidirectionalServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetServerResponse': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=bidi__pb2.Message.FromString,
                    response_serializer=bidi__pb2.Message.SerializeToString,
            ),
    }
...
class Bidirectional(object):
    ...
    def GetServerResponse(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/bidirectional.Bidirectional/GetServerResponse',
            bidi__pb2.Message.SerializeToString,
            bidi__pb2.Message.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
